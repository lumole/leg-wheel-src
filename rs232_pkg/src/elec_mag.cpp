...
public:
    SerialCommunicator()
    {
		...
		ROS_INFO_STREAM("Failed Serial port initialized");
	    }
    }
...
int main(int argc, char** argv)
{
    ...
    ros::Rate r(20);
    ros::Subscriber sub = nh.subscribe<message::rs232_elec_mag_ctrl>("/mag_ctrl", 100, boost::bind(rs232_elec_mag_ctrl_Callback, _1, boost::ref(em)));
    ros::Publisher pub = nh.advertise<message::rs232_elec_mag_state>("/mag_state", 1000);
