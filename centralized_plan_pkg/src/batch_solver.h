...
class BatchSolver {
public:
    BatchSolver(size_t N_, size_t m_, std::vector<double> xr_, std::vector<double> yr_, std::vector<double> thetar_, std::vector<double> vr_, double d_, std::vector<double> xinit_, std::vector<double> yinit_, std::vector<double> thetainit_, double ts_, double safety_dist_, std::vector<std::vector<double>> obst_)
    ...
    void set_ref_states(const std::vector<double>& v);
